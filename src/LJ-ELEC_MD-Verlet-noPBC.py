...
def Verlet(atom_coord, force, h, old_atom_coord, mass):
    ...
    for i in range(len(atom_coord)):
        ...
        # Insert below the lines defining the new positions based on the old ones + forces + drstep=h
        # >>>>>
        r0x = 2 * r0x - oldr0x + h**2 * force[i][0] / mass  # verlet
        r0y = 2 * r0y - oldr0y + h**2 * force[i][1] / mass
        # <<<<<
